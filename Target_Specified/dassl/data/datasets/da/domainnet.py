...
class DomainNet(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        test_x = self._read_data(cfg.DATASET.SOURCE_DOMAINS, split="test", num=2000)
        train_u = self._read_data(cfg.DATASET.TARGET_DOMAINS, split="train", num=10000)
        test_u = self._read_data(cfg.DATASET.TARGET_DOMAINS, split="test", num=2000)
