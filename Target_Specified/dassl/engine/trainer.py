...
class TrainerBase:
    ...
    def before_epoch(self): #        print("take this before_epoch!!!!!!!!!!!!!!!!!!!")
        pass
...
class SimpleTrainer(TrainerBase):
    ...
    def build_data_loader(self):
        ...
        self.test_loader_x = dm.test_loader_x
        self.test_loader_u = dm.test_loader_u
    ...
    def before_train(self):    # print("take this before train!!!!!!!!!!!!!!!!!!!")
    ...
    def after_train(self): #         print("take this after_train!!!!!!!!!!!!!!!!!!!")
