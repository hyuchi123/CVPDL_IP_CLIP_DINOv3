...
class IPCLIPB16(TrainerXU):
    ...
    def forward_backward(self, batch_s, batch_t):  #         print("take this forward_backward!!!!!!!!!!!!!!!!!!!")
        # B,3,224,224
    ...
    def after_epoch(self):
        ...
        if do_test:
            ...
            self.save_model(self.epoch,
                            self.output_dir,
                            model_name="model--{}--{:.2f}-->{:.2f}.pth.tar".format(self.epoch, curr_result_train, curr_result_test))
